      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-5 lg:gap-12">
          ...
          <div className="space-y-4 md:col-span-2">
            ...
            <p className="text-[11px] text-muted-foreground tracking-wide font-mono">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2.5 text-xs text-muted-foreground">
              ...
              <li>
                <a href="/#questoes-demo" className="hover:text-foreground transition-colors">
                  Questões
                </a>
              </li>
              <li>
                <a href="/#desempenho" className="hover:text-foreground transition-colors">
                  Simulados
                </a>
              </li>
              <li>
                <a href="/#mentoria" className="hover:text-foreground transition-colors">
                  Mentorias
                </a>
              </li>
            </ul>
        ...
        <div className="mt-14 border-t border-border pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-muted-foreground">
